    ...
    <div className={styles.ContactUsContainer}>
      <div className="row gx-5">
        ...
        >
          <h3>Contact Us</h3>
          <p>
            Our team are always on the standby 24/7 to ensure you have a
            seamless trading experience. You can reach us via our support email{" "}
            <a href="mailto:fiensmapdt@gmail.com">fiensmapdt@gmail.com</a> and we
