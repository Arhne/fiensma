        ...
        <div className={`row ${styles.AboutUs}`}>
          ...
          >
            ...
            <p className={styles.TagLine}>
              ...
              financial freedom, and by making more of it available to people,
              we alleviate suffering worldwide.
            </p>
          </div>
        </div>
        <div className={`row gx-5 ${styles.Mission}`}>
          ...
          >
            ...
            <p className={styles.Text}>
              At Ibx, our mission is to revolutionize the way individuals
              transact with fiat currencies. We strive to provide a secure and
              user-friendly platform that simplifies P2P trading, empowering our
              users to take control of their financial future. Through
              innovation, transparency, and exceptional customer service, we aim
              to foster trust and accessibility in the world of traditional
              currencies
            </p>
          </div>
        </div>
        <div className={`row gx-5 ${styles.Vision}`}>
          <div className={`col-xs-12 col-sm-7 ${styles.LeftColumn}`}>
            ...
            <p className={styles.LeftText}>
              Our vision is to become the leading global platform for
              peer-to-peer fiat currency trading, known for our commitment to
              security, reliability, and user experience. We envision a world
              where individuals can easily and safely engage in P2P
              transactions, unlocking the full potential of traditional
              financial systems. By fostering a vibrant community and embracing
              cutting-edge technologies, we seek to reshape the future of
              finance.
            </p>
          </div>
          ...
          <div className={`row mt-3 ${styles.teamContainer}`}>
            <div className={`col-xs-12 col-sm-12 col-lg-6 ${styles.Teamwork}`}>
              ...
              <p>
                ...
                strive to build a vibrant and inclusive community of users,
                where individuals can connect, learn from each other, and
            ...
            >
              ...
              <p>
                ...
                practices and open communication. We strive to provide a
                platform where users can transact with confidence and have full
          ...
          <div className={`row gx-5 mt-3 ${styles.Trust}`}>
            <div className={`col-xs-12 col-sm-12 col-lg-5 ${styles.Left}`}>
              ...
              <p>
                ...
                trends, and industry advancements to stay at the forefront of
                the market.
              </p>
            </div>
            <div className={`col-xs-12 col-sm-12 col-lg-7 ${styles.Right}`}>
          ...
          <div className={styles.ActionBar}>
            <p className={styles.LeftText}>
              <span className={styles.FirstSentence}>
                {" "}
                Our team of credible professionals with proven records of
                running
              </span>
